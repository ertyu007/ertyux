  ...
  return (
    <main className="simple-logs">
      ...
      <style jsx>{`
        ...
        h1 { margin:0; font-size:clamp(1.75rem, 4vw, 2.25rem); } p { color:var(--fg-dim); margin:.35rem 0 0; }
        .simple-logs__button, .simple-logs__pagination button { min-height:44px; display:inline-flex; align-items:center; justify-content:center; gap:.4rem; border:1px solid var(--glass-border); border-radius:8px; background:var(--bg-2); color:var(--fg); padding:.65rem .9rem; cursor:pointer; }
        ...
        input, select { height:44px; border:1px solid var(--glass-border); border-radius:8px; background:var(--bg-2); color:var(--fg); padding:0 .7rem; outline:none; } .simple-logs__search input { flex:1; border:0; padding:0; }
